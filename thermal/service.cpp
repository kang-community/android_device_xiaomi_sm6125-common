...
static int shutdown() {
    LOG(ERROR) << "MiA3 Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "MiA3 Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "MiA3 Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
